...
<html>
 <head>
  ...
  <title>Energy-Saver - Register</title>
  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    <div class="clearfix colelem" id="ppu104"><!-- group -->
     ...
     <div class="rounded-corners grpelem" id="u87_b"><!-- column -->
           <form id="register_form" name="register_form" method="POST" action="createuser.php">
			<ul class="nav">
			<li class="nav_title">Register to Energy&#45;Saver:</li>
			<li>Email:</li><li><input type="text" name="email" class="required email" size="25" /></li>
			<li><br/></li>
			<li>Password:</li><li><input type="password" id="password" name="password" class="required" minlength="6" size="25" /></li>
			<li><br/></li>
			<li>Name of your Avatar:</li><li><input size="10" type="text" name="avatar" maxlength="10" class="required"/></li>
			<li><br/></li>
			<li>Plugwise Device Id:</li><li><input id="plugwise" size="8" type="text" name="plugid" maxlength="8" class="plugwise" /></li>
			<li><br/></li>
			<li>Gender:</li>
