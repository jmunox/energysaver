...
<html>
 <head>
  ...
  <title>Energy-Saver - Create your Daily Agenda</title>
...
<div class="clearfix colelem" id="u103-a19"><!-- content -->
      <p id="info_about">We calculate your energy waste based on the amount of time that you spend at your office.<br/>
      Use the red scrolling bar to fix the proper amount of hours.<br/><br/>
	</p>
</div>
	...
	<li><b>DAILY AGENDA</b></li>
	<li>What is the total percentage of hours that you will be in the office <b>Today</b>?<br/></li>
	<li><br/></li>
	<li><br/></li>
	<li class="text_hours">100% corresponds to <b>8 hours of a working day</b></li>
	</ul>
	</div>
      ...
      <div class="rounded-corners clearfix colelem" id="u119"><!-- group -->
       ...
       <!-- simple frame --></div>
       <form name="register_form" method="POST" action="savedailyagenda.php" onsubmit="return registerFormValidator()">
	<p>
    ...
    <div class="rounded-corners grpelem" id="agenda_options_box"><!-- column -->
       	<p id="info_about">
       	<br/>
      	<b><span class="nav_title" >Do you prefer not to be bothered about it everyday?</span></b><br/><br/><span class="nav_title" >You can fix your agenda on a weekly basis. Try here: </span><br/><br/>
		<span class="rounded-corners clearfix colelem" id="u119b"><!-- group -->
       		<a id="gonext" class="fltrt" style="" href="createweeklyagenda.php">Weekly Agenda</a>
      		</span>
		</p>
	<!-- simple frame --></div>
...
$(function() {
	$( "#slider-agenda" ).slider({
		...
		slide: function( event, ui ) {
			$( "#amount" ).val( ui.value );
			$( "#amounthours" ).val( (ui.value*8)/100 );
			$( "#hours" ).val( ui.value );
		}
	});
	$( "#amount" ).val( $( "#slider-agenda" ).slider( "value" ) );
	$( "#amounthours" ).val( ( ( $( "#slider-agenda" ).slider( "value" ))*8)/100 );
