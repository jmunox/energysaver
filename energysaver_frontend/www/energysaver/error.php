...
<html>
 <head>
  ...
  <title>Energy-Saver - About</title>
     ...
     <div class="clearfix grpelem" id="pu104"><!-- column -->
      <div class="rounded-corners clearfix colelem" id="u104"><!-- group -->
       <div class="clearfix grpelem" id="u99-6"><!-- content -->
        <p id="u99-2">Ooops! </p>
        <p id="u99-4">Something went wrong with your request.</p>
       </div>
      </div>
      <div class="clearfix colelem" id="u103-9"><!-- content -->
       <p id="u103-2">Please try again or come back later to <b>Energy&#45;Saver</b> if the error persists.</p>
       <div id="u103-7" class="errormessage2"><br/><br/><?php echo $errormessage; ?></div>
      </div>
