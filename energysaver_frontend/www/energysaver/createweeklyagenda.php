...
<div class="clearfix colelem" id="u103-a19"><!-- content -->
	...
	<li class="text_hours">100% corresponds to <b>40 hours a week</b> (8 hours a day)</li>
      ...
      <div class="rounded-corners clearfix colelem" id="u119"><!-- group -->
       ...
       <!-- simple frame --></div>
       <form name="register_form" method="POST" action="saveweeklyagenda.php" onsubmit="return registerFormValidator()">
	<p>
	...
	<input id="saveagenda" class="fltrt" style="" type="submit" value="Save" />
     ...
     <div class="rounded-corners grpelem" id="agenda_options_box"><!-- column -->
       	<p id="info_about">
       	<br/>
      	<b><span class="nav_title" >Do you prefer more precision on your daily agenda?</span></b><br/><br/><span class="nav_title" >You can fix your agenda on a <b>DAILY BASIS</b>. Try here: </span><br/><br/>
		<span class="rounded-corners clearfix colelem" id="u119b"><!-- group -->
       		<a id="gonext" class="fltrt" style="" href="createdailyagenda.php">Daily Agenda</a>
      		</span>
		</p>
	<!-- simple frame --></div>
